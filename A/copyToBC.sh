...
scp -i .ssh/privBC.rsa -r $HOME/grs/BC $HOME/grs/netubuntu $HOME/grs/server  theuser@192.168.88.101:$HOME/grs
scp -i .ssh/privBC.rsa -r $HOME/grs/BC $HOME/grs/netubuntu $HOME/grs/server  theuser@192.168.88.102:$HOME/grs
